 ...
 */
public class WTestCrudPoRoleHolderPersonDAO extends AbstractRandomDataAndReferencesProvidingTestCase<PoRoleHolderPerson> {

	@Override
	protected void onSetUpAfterDataGeneration() throws Exception {
		setBeanClass(PoRoleHolderPerson.class);
